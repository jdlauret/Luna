SELECT
    ...
    TO_VARCHAR(PREVIOUS_DAY(DATEADD('d', -7,DATE_TRUNC('d',CURRENT_TIMESTAMP::TIMESTAMP_NTZ)),'SU'), 'MM/DD/YY') as REPORT_DATE1,
    TO_VARCHAR(NEXT_DAY(DATEADD('d',-7,DATE_TRUNC('d',CURRENT_TIMESTAMP::TIMESTAMP_NTZ)),'sa'), 'MM/DD/YY') AS REPORT_DATE2
