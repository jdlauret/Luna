WITH W1  AS
   ...
   , E3  AS (SELECT E2.*, CASE WHEN AVG(E2.ERROR_COUNT) > 0
             ...
             FROM E2
             GROUP BY E2.ERROR_DATE, E2.ERROR_BY, E2.ERROR_COUNT)
...
SELECT
    ...
    SUM(ACTVIITY_TIME) AS ACTVITITY_TIME,
...
FROM m5
WHERE BADGE = '205141' --'{badge}'
AND REPORT_DATE  >= DATE_TRUNC('d', DATEADD('DAY', -7, CURRENT_TIMESTAMP :: TIMESTAMP_NTZ))
AND REPORT_DATE  <= DATE_TRUNC('d', DATEADD('DAY', CURRENT_TIMESTAMP :: TIMESTAMP_NTZ))
