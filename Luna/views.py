...
def index(request):
    # TODO test get_token() and verify that it can refresh tokens when needed
    #  https://stackoverflow.com/questions/41466731/how-can-i-refresh-the-token-with-social-auth-app-django
    # if request.user.is_authenticated:
    #     get_token(request.user, 'google_oauth2')
    context = {
        # 'user': request.user
    }
