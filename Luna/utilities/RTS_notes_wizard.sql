...
;SELECT DISTINCT P.PROJECT_ID, ESC.ESC_SCHEDULED_FOR, NULL ARRAYS, D.SYSTEM_SIZE_DESIGNED_KW, D.MODULE_QTY, D.ROOF_TYPE, D.INVERTER_MANUFACTURER, D.INVERTER_MODEL, D.TOTAL_SOLAR_ROOFS, T.ROOF_TILT, T.ROOF_AZIMUTH_DESIGNED, T.NUM_MODULES_DESIGNED
