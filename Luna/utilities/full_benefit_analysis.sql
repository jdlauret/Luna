...
-- --     T.ACTUAL_KWH,
-- --     POWER(1.029, TRUNC(DATEDIFF('D', DATE_TRUNC('D', P.START_BILLING),DATE_TRUNC('D', CURRENT_TIMESTAMP::TIMESTAMP_NTZ))/365)) AS POWER,
-- --     TRUNC(DATEDIFF('D', DATE_TRUNC('D', P.START_BILLING),DATE_TRUNC('D', CURRENT_TIMESTAMP::TIMESTAMP_NTZ))/365) AS DATEDIFF,
-- --
...
-- -- LEFT JOIN VSLR.D_POST_INSTALL.T_UTILITY_RATES AS U ON UPPER(U.UTILITY) = UPPER(P.UTILITY_COMPANY)
-- --           AND U.STATE = P.SERVICE_STATE
-- -- WHERE P.SERVICE_NUMBER = '5266100'
-- -- AND T.READ_DATE BETWEEN '08/01/2017' AND '08/01/2018'
